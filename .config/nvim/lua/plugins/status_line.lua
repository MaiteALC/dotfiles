...
local mocha_crust = '#11111b'
local light_blue = '#86daeb'

custom_theme.normal.b.bg = mocha_crust
custom_theme.insert.b.bg = mocha_crust
custom_theme.visual.b.bg = mocha_crust
custom_theme.replace.b.bg = mocha_crust
custom_theme.command.b.bg = mocha_crust
