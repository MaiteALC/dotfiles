...
while true do
    ...
    if cpu_status then
        local total = cpu_status.iowait + cpu_status.irq + cpu_status.nice + cpu_status.softirq + cpu_status.system + cpu_status.user + cpu_status.idle
    ...
    local tooltip = string.format(
        " <b>CPU:</b> %s%% \\n <b>RAM:</b> %s \\n <b>GPU:</b> %s%% \\n <b>Disk:</b> %s ",
        cpu_usage, ram_usage, gpu_usage, disk_usage
    )
